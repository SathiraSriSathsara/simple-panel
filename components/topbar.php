...
<div class="top-bar">
    <div class="page-title">
        ...
        <span><?php echo isset($page_title) ? htmlspecialchars(t($page_title)) : htmlspecialchars(t('Dashboard')); ?></span>
    </div>

    <div class="topbar-actions">
        <form class="language-switcher" method="get">
            <input type="hidden" name="page" value="<?php echo htmlspecialchars($current_page); ?>">
            <label for="lang"><?php echo htmlspecialchars(t('Language')); ?></label>
        ...
        <div class="status-chip">
            <i class="fas fa-circle" style="color: #32b86d; font-size: 0.6rem;"></i> <?php echo htmlspecialchars(t('All Systems Operational')); ?>
        </div>
    </div>
</div>
